          ...
          <div className="flex justify-between items-end px-2">
            <div>
              ...
              <p className="text-[13px] text-slate-500 mt-1 font-medium italic">
                Theo dõi và quản lý theo trình tự thời gian
              </p>
            </div>
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-bold mt-2 uppercase tracking-tighter">
                    Technical Lead Candidate
                  </p>
                </div>
                <span className="bg-amber-100 text-amber-600 text-[10px] font-black px-2 py-1 rounded-lg">
                  Vòng 2
                </span>
              </div>
              ...
              <div className="space-y-5 border-t border-slate-50 pt-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] font-bold text-slate-700 mt-0.5 leading-relaxed">
                      Trực tiếp - Phòng họp 302, Tòa nhà A
                    </p>
                  </div>
                </div>
